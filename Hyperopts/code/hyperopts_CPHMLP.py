...
parser.add_argument("--index", help="index for Hyperopts/CPHMLP/configs")
args = parser.parse_args()
config = vars(args)
index = str(args.index)

with open(script_dir+'/CPHMLP/configs/config_'+index+'.json','r') as f:
    config = json.load(f)
f.close()
...
with open(script_dir+'/CPHMLP/results/result_config_'+index+'.pkl','wb') as f:
